...
if(isset($_POST['valider'])){
    ...
    $existe = "SELECT COUNT(nomSupplement) AS nb FROM supplements WHERE nomSupplement = :nomSupplement";

    $reqExiste = $db->prepare($existe);
    $reqExiste->bindParam(':nomSupplement', $nom);
    $reqExiste->execute();
    ...
    if($nb->nb == 0){
        ...
        $insert = "INSERT INTO supplements(nomSupplement,imageSupplement) VALUES(:nom,:image)";
        ...
        // header('Location: /admin/supplements');
...
<div class="container">
    <div id="editTypeUser" class="offset-md-2 col-md-8">
        <h2 class=" titleForm d-flex justify-content-center">Ajouter un supplément</h2>
