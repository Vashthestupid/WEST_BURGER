...
if(isset($_POST['valider'])){
    ...
    $existe = "SELECT COUNT(nomFriture) AS nb FROM friture WHERE nomFriture = :nomFriture";

    $reqExiste = $db->prepare($existe);
    $reqExiste->bindParam(':nomFriture', $nom);
    $reqExiste->execute();
    ...
    if($nb->nb == 0){
        ...
        $insert = "INSERT INTO friture(nomFriture,descFriture,prixFriture,imageFriture) VALUES(:nom,:desc,:prix,:image)";
...
<div class="container">
    <div id="editTypeUser" class="offset-md-2 col-md-8">
        <h2 class=" titleForm d-flex justify-content-center">Ajouter une friture</h2>
