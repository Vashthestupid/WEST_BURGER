...
CREATE TABLE IF NOT EXISTS `west_burger`.`menu` (
  ...
  INDEX `fk_menu_dessert1_idx` (`dessert_id` ASC),
...
CREATE TABLE IF NOT EXISTS `west_burger`.`menuSalade` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `descMenuSalade` TEXT(500) NOT NULL,
  `prixMenuSalade` INT NOT NULL,
  ...
  INDEX `fk_menuSalade_dessert1_idx` (`dessert_id` ASC),
  ...
  CONSTRAINT `fk_menuSalade_salade1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_menuSalade_dessert1`
    FOREIGN KEY (`dessert_id`)
    REFERENCES `west_burger`.`dessert` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
CREATE TABLE IF NOT EXISTS `west_burger`.`menuEnfant` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `descMenuEnfant` TEXT(500) NOT NULL,
  `prixMenuEnfant` INT NOT NULL,
  `plat_id` INT NOT NULL,
